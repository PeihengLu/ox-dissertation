...
\begin{abstract}
    ...
    Prime editing is one of the latest advances in the field of gene editing, offering a much more versatile and precise way to edit the genome compared to the CRISPR-Cas9 and base editor systems. However, its application is significantly limited by low efficiencies when using unoptimized guide RNAs. Empirical guide optimization is a time-consuming and labor-intensive process, requiring the repeated testing of a large number of guide designs to find the configuration that offers the highest efficiency. Thus, a number of computational tools have been developed for in silico guide optimization, and have achieved varying degrees of success. 

    This study further enriches the toolkits of computational guide optimization by developing a number of new machine learning models that offer superior or comparable performance to existing tools. 
\end{abstract}
