...
The result of the tuning process is shown in \autoref{fig:ensemble-adaboost-tuning}. The performance of the AdaBoost model was very sensitive to the error rate threshold, but not so much to the power of the error rate or the number of base estimators (number of rounds).
