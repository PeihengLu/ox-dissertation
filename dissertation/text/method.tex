...
\begin{figure}
    ...
    \subfigure[][Error Distribution]{
        \centering
        \includegraphics[width=\textwidth]{error_comparison.png}
        % \caption{Error Distribution of the Individual Models}
        \label{fig:error-distribution}
    }
    \subfigure[][Pearson Correlation]{
        \centering
        \includegraphics[width=0.45\textwidth]{error_correlation_pearson.png}
    ...
    \subfigure[][Spearman Correlation]{
        \centering
        \includegraphics[width=0.45\textwidth]{error_correlation_spearman.png}
        % \caption{Spearman Correlation of the Error of the Individual Models}
        \label{fig:spearman-correlation}
    }
    \caption[Error Analysis of the Individual Models]{Error Analysis of the Individual Models on the DeepPrime HEK293T dataset. \textbf{(a)} The distribution of the error of the individual models at each example, smoothened using a  \textbf{(b)} The Pearson correlation of the error of the individual models. \textbf{(c)} The Spearman correlation of the error of the individual models.}
