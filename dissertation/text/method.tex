...
The undersampling ratio was set to 10:1, with the majority of the pegRNAs with efficiency $<10$ removed (Figure \ref{fig:imbalanced-undersampling}). The ration and threshold was fine tuned in the list of [20:1, 15:1, 10:1, 5:1] and [5, 10, 15] respectively using the first fold of DeepPrime HEK293T PE2 dataset. 
...
The averaging was implemented using a single linear layer with relu activation, and the weights were optimized using the Adam optimizer with a learning rate of 0.1, additionaly adjusted by CosineAnnealingLRWarmRestart scheduler with T\_0 of 10 and T\_mult of 1.  
