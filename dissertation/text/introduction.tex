...
% A more detailed review and comparison of some existing learning-based models as well as illustrations of their architectures were done as part of my submission for the course SC8 Computational Biology, and were attached here for reference in \autoref{appendix:models}. 
