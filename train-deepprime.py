...
# 'dp-pd-adv-pe2.csv', 'dp-pd-k562-pe2.csv', 'dp-pd-k562mlh1dn-pe2.csv', 

for fname in ['dp-pd-hek293t-pe2.csv']:
    train_deep_prime(fname, hidden_size=128, num_features=24, num_layers=1, dropout=0.05, epochs=200, batch_size=1024, lr=0.005, patience=20, device='cuda', num_runs=3)
